...
-   **CLI**: Removed redundant server lifecycle commands (`start`, `stop`, `restart`, `status`) to simplify the IDE-driven workflow.
-   **Architecture**: Removed PID tracking and SSE mode reliance.
-   **Documentation**: Corrected incorrect workflow examples in README and micro-site.
